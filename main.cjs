// Option 1: Rename to main.cjs and use require syntax
const { app, BrowserWindow, ipcMain } = require("electron");
const path = require("path");
const fs = require("fs");

// Option 2: Add "type":"module" to package.json and ensure all dependencies support ESM
...
function createWindow() {
  ...
  // Add these handlers to createWindow()
  ...
  mainWindow.webContents.once('dom-ready', () => {
    ...
    mainWindow.webContents.openDevTools(); // Open DevTools in production to see errors
  });
